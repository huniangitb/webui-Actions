...
const resources = {
  en: {
    translation: {
      ...
      "sh.cardTitle": "Display Saturation & Hue",
      ...
      "toast.sh.saved": "Saturation & Hue saved.",
      "toast.sh.saveFailed": "Save failed: {{error}}",
      "toast.sh.reset": "Saturation & Hue reset to default.",
      "toast.sh.loaded": "Loaded Saturation & Hue.",
      "toast.sh.loadFailed": "Failed to load Saturation & Hue, using defaults.",
  ...
  'zh-CN': {
    translation: {
      ...
      "toast.reset": "已重置",
      "toast.sh.saved": "饱和度与色相已保存。",
      "toast.sh.saveFailed": "保存失败: {{error}}",
      "toast.sh.reset": "饱和度与色相已重置。",
      "toast.sh.loaded": "已加载饱和度与色相配置。",
      "toast.sh.loadFailed": "加载饱和度与色相配置失败，使用默认值。",
